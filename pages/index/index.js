...
Page({
  ...
  locationCorrect:function(latitude,longitude){
    ...
    var params = {       
      ...
      ak: "zGWtqgDpHg3pBAptknTaPbNQB5k7c7In" //百度网页端服务 AK     
      }     
      //调用微信访问 url 方法     
      wx.request({       
        url: url,       
  ...
  getCity: function (latitude, longitude) {     
    ...
    //访问 web 端百度 API 逆经纬度转换方法     
    var params = {       
      ak: "zGWtqgDpHg3pBAptknTaPbNQB5k7c7In",//百度网页端服务 AK（貌似微信小程序 AK 也行）       
      output: "json",       
  ...
  getWeahter: function (city) {     
    ...
    var params = {      
       location: city, 
       output: "json", 
       ak: "XaYvGBzUO0mGGvXEgZeFWiA8sT0dtRfv"//百度微信小程序 AK     
      }     
      wx.request({       
        url: url,      
        data: params,       
        success: function (res) {         
          ...
          var forecast = cast.slice(1, cast.length);//近几天天气预报过滤掉今 天         
